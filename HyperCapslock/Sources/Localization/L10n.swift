...
final class LocalizationManager: ObservableObject {
    ...
    static let tables: [AppLocale: [String: String]] = [
        .en: [
            ...
            "mappings.style": "View style", "mappings.style.list": "List", "mappings.style.grouped": "Grouped by trigger", "mappings.style.keyboard": "Keyboard map",
            ...
            "mappings.kb.hint": "Hold Caps and tap a highlighted key. Click any key to edit its mapping.", "mappings.kb.other": "Other triggers", "mappings.kb.empty_hint": "Click a key to map Caps + that key.",
        ...
        .zh: [
            ...
            "mappings.style": "显示样式", "mappings.style.list": "列表", "mappings.style.grouped": "按触发方式分组", "mappings.style.keyboard": "键盘图",
            ...
            "mappings.kb.hint": "按住 Caps 再按高亮的键。点击任意键可编辑它的映射。", "mappings.kb.other": "其它触发方式", "mappings.kb.empty_hint": "点击一个键即可为「Caps + 该键」添加映射。",
        ...
        .ja: [
            ...
            "mappings.style": "表示スタイル", "mappings.style.list": "リスト", "mappings.style.grouped": "トリガー別にグループ化", "mappings.style.keyboard": "キーボードマップ",
            ...
            "mappings.kb.hint": "Caps を押しながら、ハイライトされたキーを押します。キーをクリックするとマッピングを編集できます。", "mappings.kb.other": "その他のトリガー", "mappings.kb.empty_hint": "キーをクリックすると「Caps + そのキー」を割り当てられます。",
        ...
        .de: [
            ...
            "mappings.style": "Ansicht", "mappings.style.list": "Liste", "mappings.style.grouped": "Nach Trigger gruppiert", "mappings.style.keyboard": "Tastaturansicht",
            ...
            "mappings.kb.hint": "Halte Caps und tippe eine hervorgehobene Taste. Klicke eine Taste, um ihre Belegung zu bearbeiten.", "mappings.kb.other": "Weitere Trigger", "mappings.kb.empty_hint": "Klicke eine Taste, um „Caps + diese Taste“ zu belegen.",
