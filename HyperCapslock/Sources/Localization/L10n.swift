...
final class LocalizationManager: ObservableObject {
    ...
    static let tables: [AppLocale: [String: String]] = [
        .en: [
            ...
            "actions.hold_modifier_hint": "Hold the trigger to keep these modifiers pressed; release to let go (e.g. push-to-talk). Use with a Caps+key trigger.",
        ...
        .zh: [
            ...
            "actions.hold_modifier_hint": "按住触发键即保持这些修饰键按下,松开即释放(如按住说话)。请配合 Caps+键 这类按住型触发器使用。",
        ...
        .ja: [
            ...
            "actions.hold_modifier_hint": "トリガーを押している間これらの修飾キーを押し続け、離すと解除します(プッシュトゥトークなど)。Caps+キーのような押し続けるトリガーで使ってください。",
            "action.left": "左", "action.right": "右", "action.up": "上", "action.down": "下",
        ...
        .de: [
            ...
            "actions.hold_modifier_hint": "Halte den Trigger, um diese Modifier gedrückt zu halten; loslassen zum Beenden (z. B. Push-to-Talk). Mit einem Caps+Taste-Trigger verwenden.",
