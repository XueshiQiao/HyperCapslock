...
final class LocalizationManager: ObservableObject {
    ...
    static let tables: [AppLocale: [String: String]] = [
        .en: [
            ...
            "nav.settings": "General", "nav.mappings": "Mappings", "nav.actions": "Actions", "nav.about": "About",
        ...
        .zh: [
            ...
            "nav.settings": "通用", "nav.mappings": "按键映射", "nav.actions": "动作", "nav.about": "关于",
        ...
        .ja: [
            ...
            "nav.settings": "一般", "nav.mappings": "マッピング", "nav.actions": "アクション", "nav.about": "情報",
            ...
            "mappings.action": "アクション", "mappings.action_hint": "ライブラリからアクションを選択。新規は「アクション」タブで作成。",
        ...
        .de: [
            ...
            "nav.settings": "Allgemein", "nav.mappings": "Belegungen", "nav.actions": "Aktionen", "nav.about": "Über",
            ...
            "mappings.action": "Aktion", "mappings.action_hint": "Aktion aus der Bibliothek wählen. Neue im Tab „Aktionen“ erstellen.",
